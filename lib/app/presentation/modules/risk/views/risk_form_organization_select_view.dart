...
class RiskOrganizationSelectionScreen extends StatefulWidget {
  const RiskOrganizationSelectionScreen({Key? key});
...
class OrganizationSelectionScreenState
    extends State<RiskOrganizationSelectionScreen> {
