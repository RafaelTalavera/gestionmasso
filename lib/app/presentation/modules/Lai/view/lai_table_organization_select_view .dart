...
class LaiOrganizationSelectionTableScreen extends StatefulWidget {
  const LaiOrganizationSelectionTableScreen({Key? key});
...
class OrganizationSelectionScreenState
    extends State<LaiOrganizationSelectionTableScreen> {
                              ...
                              child: ElevatedButton(
                                onPressed: () {
                                  Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                        builder: (context) => LaiScreen(
                                            // Pasa el ID de la organización seleccionada
                                            nameOrganization:
                                                organizations[index]),
                                      ));
                                },
