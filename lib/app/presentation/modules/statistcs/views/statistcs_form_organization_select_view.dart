...
import 'statistcs_form_view.dart';

class StatistcsOrgaSelectionScreen extends StatefulWidget {
  const StatistcsOrgaSelectionScreen({super.key});
...
class OrganizationSelectionScreenState
    extends State<StatistcsOrgaSelectionScreen> {
